...
file = open('C:\\Users\\User\\Desktop\\AIHackathon\\test\\test\\data.csv', 'w')
file.write("ID,Age,Gender,Angry,Disgust,Fear,Happy,Sad,Surprised,Neutral,Style1,VStyle1,Style2,VStyle2,Style3,VStyle3\n")
file.close()
array_of_files_done = []
while(1):
    if os.listdir('C:\\Users\\User\\Desktop\\AIHackathon\\test\\test\\bin\\Debug\\OUTPUT_PICS') != []: 
        list_of_files = glob.glob('C:\\Users\\User\\Desktop\\AIHackathon\\test\\test\\bin\\Debug\\OUTPUT_PICS\\*.jpg') # * means all if need specific format then *.csv
        ...
        if((latest_file not in array_of_files_done) and latest_file != '') :
            file = open('C:\\Users\\User\\Desktop\\AIHackathon\\test\\test\\data.csv', 'a+', newline='')
